...
if(!is_numeric($appuserid) || !is_numeric($appuserid)){	
echo "Data Error";
exit;
...
$appusername= $userinfo['AppUserName'];
$appuseremail= $userinfo['AppUserEmail'];
$appuserphone= $userinfo['AppUserPhone'];
$contactaddress= $userinfo['Contact_Address'];
}
?>
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center">Edit User Info</h2>
            <!--// main-heading -->
                        ...
                        <div class="col-md-12 order-md-1 validform2">
							...
							<form>
                                <div class="mb-3">   
                                        ...
                                        <input type="text" class="form-control" id="fullname" placeholder="" value="<?php echo $appusername?>" required="">
										<span id='errorname1'style="color:red;display:none"><i class="fa fa-exclamation-triangle"></i> This field is required.</span>
                                    </div>
                                <div class="mb-3">
                                    <label for="email">Email</label>
                                    <input type="email" class="form-control" id="email" placeholder="" value="<?php echo $appuseremail?>" required="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="phone" placeholder="" value="<?php echo $appuserphone?>" minlength="10" maxlength="10" required="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="address" placeholder="" value="<?php echo $contactaddress?>" required="">
...
$("document").ready(function(){	
	...
	$("#user-form").click(function(){
		...
		var appuserid = <?php echo $appuserid?>;
		var errr="";
...
if(errr==""){		
		...
		$.ajax({ 
			type:'POST',
			data:{appuserid:appuserid,fullname:fullname,email:email,phone:phone,address:address},
			url: 'posts/updateuser.php',
  			success: function(text){
					if(text==1){
						alert("PROFILE SUCCESSFULLY EDITED!");
						window.location.href="appusersview.php";
					}
					else{
