        ...
        <tbody>
				  ...
				  <?php 
					while(@$get = mysqli_fetch_array($TABLE))
					{
						...
						$pdata=mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM ticket_priority where Priority_ID='$priority'"));
						$tic_priority=$pdata['Priority_Name'];
...
if(errr==""){	
		$.ajax({ 
			type:'POST',
			data:{application_id:application_id,module_id:module_id,screen_id:screen_id,tic_cat_id:tic_cat_id,ter_date1:ter_date1,ter_date2:ter_date2,tic_ini_date1:tic_ini_date1,tic_ini_date2:tic_ini_date2,t_priority:t_priority},
