...
<head>
    <title>E-HelpDesk | Registration</title>
    <!-- Meta Tags -->
...
?>
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center">SMS Gateway Configuration</h2>
            <!--// main-heading -->
                        ...
                        <div class="col-md-12 order-md-1 validform2">
                            ...
                            <form  action="#" method="post" class="needs-validation" novalidate="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="phonenumber" placeholder="Contact Number" minlength="10" maxlength="10" required="">
                                    <div class="invalid-feedback">
