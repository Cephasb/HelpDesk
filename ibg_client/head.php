...
$uid = $_SESSION['id'];
$stmt = $conn->prepare("SELECT * FROM ticket JOIN ticket_staff_assignment ON ticket.Ticket_ID=ticket_staff_assignment.Ticket_ID WHERE ticket_staff_assignment.AppUser_ID=?");
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu3">
                        ...
                        <li>
                            <a href="ticketing.php">Fault Reporting</a>
                        </li>
                        <li>
                           <a href="ticket_resolve.php">Fault Resolution</a>
                        </li>
                    </ul>
                </li>
                <li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu drop-3">
                                ...
                                <a href="profile.php" class="dropdown-item mt-3">
                                    <h4>
                                     <i class="far fa-user mr-3"></i>My Profile</h4></a>
                                </a>
                                <a href="#" class="dropdown-item mt-3">
                                    <h4>
                                    <i class="fas fa-link mr-3"></i>Change Picture</h4>
                                </a>
